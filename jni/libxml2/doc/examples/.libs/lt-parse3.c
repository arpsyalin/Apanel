...
/* ./.libs/lt-parse3.c - temporary wrapper executable for .libs/parse3
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh parse3",
   but could eventually absorb all of the scripts functionality and
   exec .libs/parse3 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "parse3"; /* hopefully, no .exe */
