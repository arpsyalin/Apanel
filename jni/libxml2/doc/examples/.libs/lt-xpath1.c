...
/* ./.libs/lt-xpath1.c - temporary wrapper executable for .libs/xpath1
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh xpath1",
   but could eventually absorb all of the scripts functionality and
   exec .libs/xpath1 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "xpath1"; /* hopefully, no .exe */
