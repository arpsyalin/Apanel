...
/* ./.libs/lt-parse2.c - temporary wrapper executable for .libs/parse2
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh parse2",
   but could eventually absorb all of the scripts functionality and
   exec .libs/parse2 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "parse2"; /* hopefully, no .exe */
