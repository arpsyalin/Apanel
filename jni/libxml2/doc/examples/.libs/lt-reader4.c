...
/* ./.libs/lt-reader4.c - temporary wrapper executable for .libs/reader4
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh reader4",
   but could eventually absorb all of the scripts functionality and
   exec .libs/reader4 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "reader4"; /* hopefully, no .exe */
