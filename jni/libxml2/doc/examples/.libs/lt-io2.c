...
/* ./.libs/lt-io2.c - temporary wrapper executable for .libs/io2
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh io2",
   but could eventually absorb all of the scripts functionality and
   exec .libs/io2 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "io2"; /* hopefully, no .exe */
