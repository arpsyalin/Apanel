...
/* ./.libs/lt-tree2.c - temporary wrapper executable for .libs/tree2
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh tree2",
   but could eventually absorb all of the scripts functionality and
   exec .libs/tree2 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "tree2"; /* hopefully, no .exe */
