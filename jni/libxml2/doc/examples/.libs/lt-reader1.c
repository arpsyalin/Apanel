...
/* ./.libs/lt-reader1.c - temporary wrapper executable for .libs/reader1
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh reader1",
   but could eventually absorb all of the scripts functionality and
   exec .libs/reader1 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "reader1"; /* hopefully, no .exe */
