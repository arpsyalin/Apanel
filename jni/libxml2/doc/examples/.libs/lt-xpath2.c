...
/* ./.libs/lt-xpath2.c - temporary wrapper executable for .libs/xpath2
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh xpath2",
   but could eventually absorb all of the scripts functionality and
   exec .libs/xpath2 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "xpath2"; /* hopefully, no .exe */
