...
/* ./.libs/lt-tree1.c - temporary wrapper executable for .libs/tree1
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh tree1",
   but could eventually absorb all of the scripts functionality and
   exec .libs/tree1 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "tree1"; /* hopefully, no .exe */
