...
/* ./.libs/lt-parse4.c - temporary wrapper executable for .libs/parse4
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh parse4",
   but could eventually absorb all of the scripts functionality and
   exec .libs/parse4 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "parse4"; /* hopefully, no .exe */
