...
/* ./.libs/lt-parse1.c - temporary wrapper executable for .libs/parse1
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh parse1",
   but could eventually absorb all of the scripts functionality and
   exec .libs/parse1 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "parse1"; /* hopefully, no .exe */
