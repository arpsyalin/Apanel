...
/* ./.libs/lt-reader3.c - temporary wrapper executable for .libs/reader3
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh reader3",
   but could eventually absorb all of the scripts functionality and
   exec .libs/reader3 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "reader3"; /* hopefully, no .exe */
