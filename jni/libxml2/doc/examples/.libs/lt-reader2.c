...
/* ./.libs/lt-reader2.c - temporary wrapper executable for .libs/reader2
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh reader2",
   but could eventually absorb all of the scripts functionality and
   exec .libs/reader2 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "reader2"; /* hopefully, no .exe */
