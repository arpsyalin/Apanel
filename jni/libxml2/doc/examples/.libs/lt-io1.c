...
/* ./.libs/lt-io1.c - temporary wrapper executable for .libs/io1
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh io1",
   but could eventually absorb all of the scripts functionality and
   exec .libs/io1 directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "io1"; /* hopefully, no .exe */
