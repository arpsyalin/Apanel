...
/* ./.libs/lt-testWriter.c - temporary wrapper executable for .libs/testWriter
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh testWriter",
   but could eventually absorb all of the scripts functionality and
   exec .libs/testWriter directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "testWriter"; /* hopefully, no .exe */
