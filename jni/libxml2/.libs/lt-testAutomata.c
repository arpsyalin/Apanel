...
/* ./.libs/lt-testAutomata.c - temporary wrapper executable for .libs/testAutomata
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh testAutomata",
   but could eventually absorb all of the scripts functionality and
   exec .libs/testAutomata directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "testAutomata"; /* hopefully, no .exe */
