...
/* ./.libs/lt-testSAX.c - temporary wrapper executable for .libs/testSAX
   Generated by ltmain.sh (GNU libtool) 2.2.6b

   The testSAX program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh testSAX",
   but could eventually absorb all of the scripts functionality and
   exec .libs/testSAX directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
static const char *script_text_part1 =
  "#! /bin/sh\n"
  "\n"
  "# testSAX - temporary wrapper script for .libs/testSAX\n"
  "# Generated by ltmain.sh (GNU libtool) 2.2.6b\n"
  "#\n"
  "# The testSAX program cannot be directly executed until all the libtool\n"
  "# libraries that it depends on are installed.\n"
...
const char * TARGET_PROGRAM_NAME = "testSAX"; /* hopefully, no .exe */
